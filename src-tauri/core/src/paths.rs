...
//!   public contract (see `docs/MAP.md`), and keeping the shape identical means
...
mod tests {
    ...
    fn library_path_is_identical_on_every_platform() {
        assert_eq!(
            storage_root_in(Path::new("/home/george")),
            Path::new("/home/george/Notetaker")
        );
        assert_eq!(
            storage_root_in(Path::new(r"C:\Users\george")),
            Path::new(r"C:\Users\george").join("Notetaker")
        );
    }

    #[test]
    fn storage_root_never_depends_on_the_platform_argument() {
        let home = Path::new("/home/george");
    ...
    fn windows_app_dir_uses_appdata_when_set() {
        let dir = app_dir_in(
            Platform::Windows,
            Path::new(r"C:\Users\george"),
            Some(Path::new(r"C:\Users\george\AppData\Roaming")),
            None,
        );
        assert_eq!(
            dir,
            Path::new(r"C:\Users\george\AppData\Roaming").join("Notetaker")
        );
    }
    ...
    fn windows_app_dir_falls_back_to_roaming_under_home() {
        let home = Path::new(r"C:\Users\george");
    ...
    fn macos_app_dir_is_application_support() {
        let dir = app_dir_in(Platform::MacOs, Path::new("/Users/george"), None, None);
        assert_eq!(
            dir,
            Path::new("/Users/george/Library/Application Support/Notetaker")
        );
    }
    ...
    fn xdg_app_dir_uses_xdg_data_home_when_set() {
        let dir = app_dir_in(
            Platform::Xdg,
            Path::new("/home/george"),
            None,
            Some(Path::new("/home/george/.local/share")),
        );
        assert_eq!(dir, Path::new("/home/george/.local/share/Notetaker"));
    }

    #[test]
    fn xdg_app_dir_falls_back_to_dot_local_share() {
        let dir = app_dir_in(Platform::Xdg, Path::new("/home/george"), None, None);
        assert_eq!(dir, Path::new("/home/george/.local/share/Notetaker"));
    }
